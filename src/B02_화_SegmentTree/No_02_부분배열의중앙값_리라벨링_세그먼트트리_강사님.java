...
public class No_02_부분배열의중앙값_리라벨링_세그먼트트리_강사님 {
    static int midTree[];
    static long sol;
    static part partArr[];

    public static void main(String args[]) throws NumberFormatException, IOException {
        BufferedReader br = new BufferedReader(new FileReader("No_부분배열의 중앙값.txt"));
        ...
        for (int testCase = 1; testCase < T + 1; testCase++) {
            ...
            if (K == 1) {
                ...
                for (int midSel = 0; midSel < N - K; midSel++) {
                    ...
                    update(1, N, 1, baseArr[sP], -1);
                    sP++; //앞에 하나 빼기
                    update(1, N, 1, baseArr[eP], 1);
                    eP++;  //끝에 하나 넣기
                }
